...
output_folder = 'C:\Users\Berk\Desktop\Business\KOU 24-25 Guz\Image Processing\Project\datasets\Standart_Median_Filtered';
...
for img = 1:length(image_files)
    ...
    save_path = fullfile(output_folder, sprintf('standart_median_filtered_%s', image_files(img).name));
    imwrite(output_img, save_path);
end

disp('Standard Median Filter is done.');
